...
export default function Censor({ navigation }) {
  return (
    <SafeAreaView style={styles.safeArea} edges={['top']}>
      <View style={styles.header}>
        <View style={styles.headerContent}>
          ...
          <View>
            ...
            <Text style={styles.headerSubtitle}>Quản lý kiểm duyệt</Text>
          </View>
        </View>
      </View>
      ...
      <View style={styles.container}>
        <View style={styles.emptyContainer}>
          ...
          <Text style={styles.emptyTitle}>Chưa có nội dung kiểm duyệt</Text>
