...
export default function MyStore({ navigation }) {
    ...
    const getService = async () => {
        try {
            const res = await axios.get(`http://localhost:8082/store/${ownerId}`);
    ...
    const addService = async () => {
        ...
        try {
            const response = await axios.post(`http://localhost:8082/store/create-service/${storeId}`, {
                services: [{
    ...
    const handleUpdateService = async () => {
        ...
        try {
            await axios.put(`http://localhost:8082/store/edit-service/${storeId}`, {
